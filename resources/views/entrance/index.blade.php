                    ...
                    <div>
                        <div id="recipients" class="tw-p-8 tw-mt-6 tw-rounded tw-shadow tw-bg-white card tw-mt-4">
                          ...
                          <div class="tw-flex tw-justify-center">
                            <button class="tw-bg-blue-500 hover:tw-bg-blue-400 tw-text-white tw-font-bold tw-py-2 tw-px-6 tw-border-b-4 tw-border-blue-700 hover:tw-border-blue-500 tw-rounded tw-mr-2 button" onclick="toggle_visibility()">
                                Create Exam
                            </button>
                            <a class="tw-bg-blue-500 hover:tw-bg-blue-400 tw-text-white tw-font-bold tw-py-2 tw-px-6 tw-border-b-4 tw-border-blue-700 hover:tw-border-blue-500 tw-rounded tw-mr-2" href="{{url('/student')}}">
                                Give Exam
                            </a>
                            <button class="tw-bg-blue-500 hover:tw-bg-blue-400 tw-text-white tw-font-bold tw-py-2 tw-px-6 tw-border-b-4 tw-border-blue-700 hover:tw-border-blue-500 tw-rounded tw-mr-2">
                                Result
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6 col-lg-offset-3">
                                <div class="custom-form">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="teacher_name" class="form-control " id="exam_teacher" placeholder="Enter Teacher Name" autocomplete="off" required>
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label" for="formGroupExampleInput2">Course Name</label>
                                    <select name="course" class="form-control sumoselect">
                                        <option disabled="" selected="" value="Select Name">Select Name</option>
                                ...
                                <div class="form-group">
                                    <label class="col-form-label" for="formGroupExampleInput2">Question Length</label>
                                    <input type="text" name="question_length" class="form-control" id="formGroupExampleInput2" placeholder="E.g 10" autocomplete="off" required>
                                </div>
                                {{-- <div class="form-group">
